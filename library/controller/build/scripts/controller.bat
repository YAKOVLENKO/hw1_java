...
set CLASSPATH=%APP_HOME%\lib\controller-1.0-SNAPSHOT.jar;%APP_HOME%\lib\models-1.0-SNAPSHOT.jar;%APP_HOME%\lib\gson-2.8.8.jar;%APP_HOME%\lib\annotations-12.0.jar


@rem Execute controller
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONTROLLER_OPTS%  -classpath "%CLASSPATH%" Application %*
